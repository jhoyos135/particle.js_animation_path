var btcPath = "https://image.ibb.co/nDzR3c/LOGO1_black.jpg";
...
var sketch = function(p){
  ...
  var starsColor = ['#fff', '#d3d3d3', '#e63946'];
  var translate = {
    x: containerWidth / 2,
  ...
  var bgColor = p.color('rgba(0,52,89,1)');
    ...
    var btc = p.loadImage(btcPath, function(img) {
      ...
      for( var x=0; x < btc.width; x++){
        for( var y=0; y < btc.height; y++){
          ...
          if(btc.pixels[index] < 100){ // if channel red < 200 == black in this case
